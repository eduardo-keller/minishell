...
t_token *create_demo_token_list(void) {
    ...
    t_token *t3 = create_tok(REDIR_OUT, ">");
    t_token *t4 = create_tok(WORD, "output.txt");
    t_token *t5 = create_tok(PIPE, "|");
    t_token *t6 = create_tok(WORD, "grep");
    t_token *t7 = create_tok(WORD, "minishell");
